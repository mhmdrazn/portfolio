...
export const StickyScroll = ({
  ...
  return (
    <motion.div
      ...
      ref={ref}
    >
      <div className="lg:hidden text-white flex h-fit md:h-fit w-full font-bold md:text-[56px] px-8 py-12 z-10 backdrop-blur-sm text-[2rem] sticky top-0 lg:leading-tight md:leading-none leading-tight lg:items-center text-left ">
        My Career and <br /> Expertise Journey.
      </div>
      <h1 className="hidden text-white lg:flex h-full w-fit font-bold text-[56px] sticky top-0 lg:leading-tight items-center text-left">
